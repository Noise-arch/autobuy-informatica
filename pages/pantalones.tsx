...
export default function Pantalones({}: Props) {
            ...
            <Link href={"/buzos"}>
              <a className="mt-6 w-full rounded-xl border flex flex-col items-center gap-4 p-4 text-left hover:text-blue-600 focus:text-blue-600">
                ...
                <div className="flex justify-between w-full items-center">
                  <h3 className="text-xl font-bold">Joggin Negro</h3>
                  <p className="text-xl font-bold"> AR$ 2000</p>
                </div>
              </a>
            </Link>
            <Link href={"/buzos"}>
              <a className="mt-6 w-full rounded-xl border flex flex-col items-center gap-4 p-4 text-left hover:text-blue-600 focus:text-blue-600">
                <div className="relative w-full h-96">
                  <Image src={"/pantalon-2.jpeg"} layout="fill" />
                </div>
                <div className="flex justify-between w-full items-center">
                  <h3 className="text-xl font-bold">Jean Naranja</h3>
                  <p className="text-xl font-bold"> AR$ 3000</p>
                </div>
              </a>
            </Link>
            <Link href={"/buzos"}>
              <a className="mt-6 w-full rounded-xl border flex flex-col items-center gap-4 p-4 text-left hover:text-blue-600 focus:text-blue-600">
                <div className="relative w-full h-96">
                  <Image src={"/pantalon-3.jpeg"} layout="fill" />
                </div>
                <div className="flex justify-between w-full items-center">
                  <h3 className="text-xl font-bold">Pantalón Azul</h3>
                  <p className="text-xl font-bold"> AR$ 1500</p>
                </div>
              </a>
            </Link>
          </div>
