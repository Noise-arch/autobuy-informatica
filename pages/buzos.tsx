...
export default function Buzos({}: Props) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      ...
      <div className="fixed bottom-4 left-4">
        <p>
          By Iñaki Martínez Bertran & Matias Valtolina
        </p>
      </div>
        ...
        <div className="container mx-auto flex flex-col w-full flex-wrap justify-around">
          ...
          <div className="grid grid-cols-4 gap-4">
            <Link href={"/buzos"}>
              <a className="mt-6 w-full rounded-xl border flex flex-col items-center gap-4 p-4 text-left hover:text-blue-600 focus:text-blue-600">
                ...
                <div className="flex justify-between w-full items-center">
                  <h3 className="text-xl font-bold">Buzo Princeton</h3>
            ...
            <Link href={"/buzos"}>
              <a className="mt-6 w-full rounded-xl border flex flex-col items-center gap-4 p-4 text-left hover:text-blue-600 focus:text-blue-600">
                <div className="relative w-full h-96">
                  <Image src={"/buzo-2.jpeg"} layout="fill" />
                </div>
                <div className="flex justify-between w-full items-center">
                  <h3 className="text-xl font-bold">Buzo Pokémon</h3>
                  <p className="text-xl font-bold"> AR$ 5500</p>
                </div>
              </a>
            </Link>
